              ...
              <div className="relative h-[110%] md:[h-120%]  lg:h-[130%] bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl border-2 border-[#0F2E52]/10 hover:border-[#2098D0]/30 transition-all duration-500">
                ...
                <div className="relative p-4 flex flex-col justify-between" style={{ height: 'calc(100% - 180px)' }}>
                  <div>
                    ...
                    <p className="text-[#255490]/70 text-xs leading-relaxed mb-4">
                      {service.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {service.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 bg-[#0F2E52]/5 text-[#0F2E52] text-xs/3 font-semibold rounded-lg border border-[#0F2E52]/10"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  {/* CTA Button */}
                  <button className="group/btn w-full py-2 px-4 mb-2 bg-[#0F2E52] text-white rounded-xl font-semibold flex items-center justify-between hover:bg-[#255490] transition-all duration-300">
