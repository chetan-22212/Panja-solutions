...
export function Footer() {
  return <footer className="relative bg-[#0F2E52] text-white pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,_#2098D0_0%,_transparent_50%)] blur-[100px]" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-5">
            <Link to="/" className="inline-block mb-8">
              <span className="font-bold text-2xl tracking-tight">PANJA</span>
            </Link>
